...
#
# `roster()` is the source. Role is read from what a node HOLDS and can discharge, so the roster is
# not a fixed seven: the subset assertion below is what proves derivation rather than declaration —
# a node holding two crystals reports two.
