...
# injection.
import agience_chorus.sage.retrieval as _op_retrieve  # noqa: E402 — persona-local organon (op.retrieve)
...
async def server_startup() -> None:
    ...
    try:
        import agience_chorus.sage.reach_provider as _reach_provider   # sage-local
...
async def corpus_search(query: str, limit: int = 10) -> str:
    ...
    try:
        from agience_chorus.sage import content_search as _cs
    except ImportError:
...
# ---------------------------------------------------------------------------
from agience_chorus.sage.web_extract import html_to_text, looks_like_html
