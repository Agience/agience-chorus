...
from agience_chorus.lumen import router as _ember_router  # noqa: E402
...
import agience_chorus.corpus_fts as _fts  # noqa: E402  (chorus's vendored lexical index — see corpus_fts.py)
