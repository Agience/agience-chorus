...
from agience_chorus.sage import canon  # noqa: E402  (sage-local)
...
def test_real_pharos_canon_ingests_with_citations(tmp_path):
    ...
    candidates = [
        here.parents[5] / "agience-pharos" / "genesis",   # <workspace>/agience-pharos/genesis
        here.parents[5] / "_pharos" / "genesis",          # workspace root, alternate name
        here.parents[2] / "aria" / "pharos" / "genesis",  # chorus-internal (under the package)
    ]
