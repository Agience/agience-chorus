...
def _profiles_root() -> Path:
    ...
    """
    from agience_chorus.ophan import licensing  # deferred: the module is persona-local (see the `import licensing` note below)
...
def _licensing_service():
    ...
    from agience_chorus.ophan import licensing  # noqa: E402 — see docstring
