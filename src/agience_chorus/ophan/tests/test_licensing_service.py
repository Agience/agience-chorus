"""Tests for src/ophan/licensing.py."""
import base64
import sys
...
# Put ophan/ on sys.path so `import licensing` resolves. The bare
# `licensing` name doesn't collide with anything else in mantle/ — this is
# the persona's own private module.
_HERE = Path(__file__).resolve().parent
sys.path.insert(0, str(_HERE.parent))

import agience_chorus.ophan.licensing as licensing_service  # noqa: E402
