...
Usage (from the repo root):
    ...
    python -m ophan.scripts.distribution_preflight \
...
Lives in `src/ophan/scripts/` because licensing is the Ophan
persona's domain (finance and licensing).
"""
...
def main() -> int:
    from agience_chorus.ophan import licensing  # noqa: E402 — sys.path adjusted above
