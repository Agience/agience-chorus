...
from agience_chorus.seraph.agent.cleanup import DocsCleanupAgent, content_hash
from agience_chorus.seraph.agent.mantle_client import MantleClient
from agience_chorus.seraph.agent.transport import HttpResponse
...
def test_reasoner_module_is_gone():
    ...
    with pytest.raises(ImportError):
        from agience_chorus.seraph.agent import reasoner  # noqa: F401
    import agience_chorus.seraph.agent as agent_pkg
