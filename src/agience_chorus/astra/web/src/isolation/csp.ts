 ...
 *
 * Always returns a full policy: the restrictive default, extended with
 * whatever `connectDomains`, `resourceDomains`, and `frameDomains` are
 * declared. With none declared, connect-src and frame-src are 'none' and
 * script-src/style-src/img-src/media-src allow only inline content and
 * data: URIs.
 */
