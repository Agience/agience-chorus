...
export default function InputPanel() {
  ...
  // Recognizes Agience artifact drags only; native file drags are not handled here.
  ...
  // Handle drops on CardGrid: distinguish artifacts already in the panel from ones being added from the workspace.
  ...
  // Background drop handlers, used only when the panel is empty.
  ...
  return (
    <div className="flex flex-col h-full max-h-full">
      ...
      >
        {/* Artifact grid: scrollable container; the wrapper itself has no padding. */}
