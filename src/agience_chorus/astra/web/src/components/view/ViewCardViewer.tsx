 ...
 * ViewCardViewer
 *
 * Viewer for "view" artifacts – saved views over other collections or
 * workspaces. Supports collection-targeted views and exposes a single
 * "Open collection view" action that delegates to the main layout via
 * onOpenCollection.
 */
export function ViewCardViewer({ artifact, mode = 'floating', onOpenCollection }: ViewCardViewerProps) {
	...
	// Resolves the target collection ID from the artifact context. Canonical shape:
	// {
