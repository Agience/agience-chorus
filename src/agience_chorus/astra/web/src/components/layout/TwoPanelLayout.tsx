 ...
 * TwoPanelLayout
 *
 * Layout shell with two resizable horizontal panels and a drag handle:
 * search occupies the left panel and the workspace occupies the right.
