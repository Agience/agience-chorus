...
def store_respond(store: Any, text: str, *, act: str = "respond",
    ...
    try:
        from lumen import conversation as _conv           # cross-persona host (chorus/src on path)
    except ImportError:
        import conversation as _conv                      # lumen-local (persona process has lumen/ on path)
...
def respond_handler(store: Any = None, *, act: str = "respond",
    ...
    def handler(need: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            from _host_seams import resolve as _seam
