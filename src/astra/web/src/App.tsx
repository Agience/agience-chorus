...
import { ContentTypesProvider } from './context/contenttypes/ContentTypesProvider';
...
// The converse facet of crystal.workbench — the crystal layer's visible face (§12).
  ...
  return (
    <SetupGate>
      <Routes>
        ...
        {/* crystal.workbench — converse (lumen tekton) + the activated crystal panel.
            Static segment, so it ranks above the /:artifactId dynamic route. */}
