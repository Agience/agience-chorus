 ...
 *
 * PaletteProvider is mounted by the host via the declarable provider system
 * (presentation.json `"provider": "palette"`); this component consumes that
 * context directly rather than creating its own provider.
 */
