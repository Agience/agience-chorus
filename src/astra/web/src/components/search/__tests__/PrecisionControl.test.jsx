// src/components/search/__tests__/PrecisionControl.test.jsx
...
describe('PrecisionControl', () => {
  ...
  describe('Rendering', () => {
    it('renders slider with initial value', () => {
      ...
      render(<PrecisionControl value={0.5} onChange={onChange} />);
  ...
  describe('Label Mapping', () => {
    it('shows "None" label for value 0', () => {
      const onChange = vi.fn();
      render(<PrecisionControl value={0} onChange={onChange} />);
    ...
    it('shows "Precise" label for value 0.1', () => {
      const onChange = vi.fn();
      render(<PrecisionControl value={0.1} onChange={onChange} />);
    ...
    it('shows "Focused" label for value 0.3', () => {
      const onChange = vi.fn();
      render(<PrecisionControl value={0.3} onChange={onChange} />);
    ...
    it('shows "Wide" label for value 0.7', () => {
      const onChange = vi.fn();
      render(<PrecisionControl value={0.7} onChange={onChange} />);
    ...
    it('shows "Very Wide" label for value 1.0', () => {
      const onChange = vi.fn();
      render(<PrecisionControl value={1.0} onChange={onChange} />);
  ...
  describe('Show/Hide', () => {
    it('renders control when show=true', () => {
      const onChange = vi.fn();
      render(<PrecisionControl value={0.5} onChange={onChange} show={true} />);
    ...
    it('does not render control when show=false', () => {
      const onChange = vi.fn();
      render(<PrecisionControl value={0.5} onChange={onChange} show={false} />);
  ...
  describe('Value Sync', () => {
    it('updates local value when prop value changes', () => {
      const onChange = vi.fn();
      const { rerender } = render(<PrecisionControl value={0.5} onChange={onChange} />);
      
      const slider = screen.getByRole('slider');
      expect(slider).toHaveValue('0.5');
      
      // Parent updates value
      rerender(<PrecisionControl value={0.7} onChange={onChange} />);
  ...
  describe('Edge Cases', () => {
    it('handles value 0.0 correctly', () => {
      const onChange = vi.fn();
      render(<PrecisionControl value={0.0} onChange={onChange} />);
    ...
    it('handles intermediate values between presets', () => {
      const onChange = vi.fn();
      render(<PrecisionControl value={0.65} onChange={onChange} />);
    ...
    it('cleans up debounce timer on unmount', () => {
      vi.useFakeTimers();
      const onChange = vi.fn();
      const { unmount } = render(<PrecisionControl value={0.5} onChange={onChange} />);
