// Storybook stories for PrecisionControl.

import { useState } from 'react';
import PrecisionControl from './PrecisionControl';

export default {
  title: 'Search/PrecisionControl',
  component: PrecisionControl,
};
...
export const Default = () => {
  ...
  return (
    <div className="p-8 max-w-xl">
      <h1 className="text-2xl font-bold mb-4">Precision Control - Full Mode</h1>
      <PrecisionControl value={value} onChange={setValue} show={true} />
...
export const Compact = () => {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-4">Precision Control - Compact Mode</h1>
...
export const PresetInteraction = () => {
  ...
  // Simulate result count changes based on precision
  const handleChange = (newValue: number) => {
    setValue(newValue);
    
    // Simulate: lower precision = fewer results
  ...
  return (
    <div className="p-8 max-w-xl">
      ...
      <PrecisionControl value={value} onChange={handleChange} show={true} />
