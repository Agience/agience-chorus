 ...
 * resolved search-result artifacts as a grid or list (read-only), toggled
 * via the view mode control.
 *
 * Artifact resolution (SearchHit → Artifact) happens in the host (MainLayout).
 * This component is controlled: the host supplies `artifacts` after
 * resolving hits.
 */
...
export interface SearchPanelProps {
  ...
  /** Sort/precision controls (forwarded from MainLayout). */
...
export function SearchPanel({
  ...
  onCollectionSelect,
  sortMode,
  // onSortChange is part of the props contract but not read by this component.
  precision,
  onPrecisionChange,
}: SearchPanelProps) {
