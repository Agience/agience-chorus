 ...
 * ContainerCardViewer
 *
 * Viewer for container artifacts (Resources, Tools, Prompts).
        ...
        {isTreeMode ? (
            ...
            {contentType.id !== 'resources' &&
              ...
              contentType.id !== 'prompts' && (
                <div className="text-xs text-gray-500">
                  Detailed view is available for resources, tools and prompts.
                </div>
              )}
          </>
        ) : (
          <>
            ...
            {contentType.id !== 'resources' &&
              ...
              contentType.id !== 'prompts' && (
                <div className="text-xs text-gray-500">
                  Grid view is available for resources, tools and prompts.
                </div>
              )}
          </>
        )}
...
// Persist layout changes back into the artifact context so that each container
// instance owns its own view behavior (default_mode and group_by).
