...
// Type color accents apply to grid artifacts; the preview header stays neutral.
 ...
 *
 * Combines preview and editing inline: markdown content can be edited
 * directly with live preview, and context fields (title, tags) and
 * collection membership are editable in place.
 */
