...
/**
 * EditorFactory routes content to a MIME-specific editor. Content type is
 * detected but not used to select between editors — every type (markdown,
 * JSON, code, plain text) renders through MarkdownEditor (@uiw/react-md-editor).
 */
export function EditorFactory({
  ...
  // All editable content routes to MarkdownEditor regardless of detected type.
  switch (contentType) {
    case 'markdown':
    case 'json':
    case 'javascript':
