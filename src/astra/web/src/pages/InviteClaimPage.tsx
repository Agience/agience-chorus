 ...
 * - Post-auth + target match: full context is handled by the backend via
 *   /grants/invite-details and is not rendered here — the claim call
 *   succeeds and redirects to the resource.
 */
